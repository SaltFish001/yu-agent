...
function createTestDb(): DatabaseSync {
  ...
  try {
    db.exec('ALTER TABLE topics ADD COLUMN pid INTEGER')
  } catch {
    /* ignore */
  }
  try {
    db.exec('ALTER TABLE topics ADD COLUMN cmd TEXT DEFAULT ""')
  } catch {
    /* ignore */
  }
  try {
    db.exec('ALTER TABLE topics ADD COLUMN started_at TEXT')
  } catch {
    /* ignore */
  }
